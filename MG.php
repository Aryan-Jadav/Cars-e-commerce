...
<main>
  <div class="container">
    <h1 id="Car-title"><strong>MG Car Models</strong></h1>
    <div class="row row-cols-1 row-cols-md-4 g-4">
      <?php
      $sql_about = "Select * from categories where car_brand = 'MG' order by id desc";
      ...
      while ($row_about = mysqli_fetch_assoc($result_about)) {
        ...
        $car_id = $row_about['id']; // added this line to retrieve the car ID
     ?>
      <div class="col">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text"><?php echo $car_description;?><a href="sub_category.php?id=<?php echo $car_id;?>">click here</a></p>
          </div>
        </div>
      </div>
      <?php }?>
